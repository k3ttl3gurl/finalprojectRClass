...
metagenomic_data_cleaned <- read_rds("metagenomic_data_cleaned.rds")  # Assuming you saved it
...
# You can choose a column that is numeric to visualize its distribution
# Let's say we want to visualize the first numeric column
